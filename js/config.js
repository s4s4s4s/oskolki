...
/* Слои корпуса — классы памяти. По умолчанию выключено «выводимое»: это
   карточки SAT, шаблоны и машинные сводки — 455 объектов из 680, которые растут
   сами и на карте знания только шумят. Найти их через поиск можно всегда,
   слой включается одним нажатием. `card` остаётся для вальтов без классов. */
export const HIDDEN_LAYERS = ['выводимое', 'card'];
