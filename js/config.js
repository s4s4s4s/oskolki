...
/* Слои корпуса — это `type` заметки. Карточки SAT растут тысячами и на карте
   памяти только шумят, поэтому слой выключен по умолчанию, но существует:
   найти карточку через поиск можно всегда, включив слой одним нажатием. */
export const HIDDEN_LAYERS = ['card'];
